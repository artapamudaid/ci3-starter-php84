		...
		<div class="col-lg-4">
			<div class="card card-transparent card-block card-stretch card-height border-none">
				<div class="card-body p-0 mt-lg-2 mt-0">
					<h3 class="mb-3">Hallo <?= $this->session->userdata('user')->full_name; ?></h3>
				</div>
			</div>
		</div>
		<div class="col-lg-8">
						...
						<div class="card-body">
							<div class="d-flex align-items-center mb-4 card-total-sale">
								<div class="icon iq-icon-box-2 bg-info-light">
									<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/1.png" class="img-fluid" alt="image">
								</div>
								<div>
						...
						<div class="card-body">
							<div class="d-flex align-items-center mb-4 card-total-sale">
								<div class="icon iq-icon-box-2 bg-danger-light">
									<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/2.png" class="img-fluid" alt="image">
								</div>
								<div>
						...
						<div class="card-body">
							<div class="d-flex align-items-center mb-4 card-total-sale">
								<div class="icon iq-icon-box-2 bg-success-light">
									<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/3.png" class="img-fluid" alt="image">
								</div>
								<div>
							...
							<div class="card card-block card-stretch card-height mb-0">
								<div class="card-body">
									<div class="bg-warning-light rounded">
										<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/01.png" class="style-img img-fluid m-auto p-3" alt="image">
									</div>
							...
							<div class="card card-block card-stretch card-height mb-0">
								<div class="card-body">
									<div class="bg-danger-light rounded">
										<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/02.png" class="style-img img-fluid m-auto p-3" alt="image">
									</div>
									<div class="style-text text-left mt-3">
							...
							<div class="card card-block card-stretch card-height mb-0">
								<div class="card-body">
									<div class="bg-info-light rounded">
										<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/03.png" class="style-img img-fluid m-auto p-3" alt="image">
									</div>
									<div class="style-text text-left mt-3">
		...
		<div class="col-lg-4">  
			...
			<div class="card card-block card-stretch card-height-helf">
				<div class="card-body card-item-right">
					<div class="d-flex align-items-top">
						<div class="bg-warning-light rounded">
							<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/04.png" class="style-img img-fluid m-auto" alt="image">
						</div>
			...
			<div class="card card-block card-stretch card-height-helf">
				<div class="card-body card-item-right">
					<div class="d-flex align-items-top">
						<div class="bg-danger-light rounded">
							<img src="<?= base_url() . 'assets/poshdash/'; ?>images/product/05.png" class="style-img img-fluid m-auto" alt="image">
						</div>
						<div class="style-text text-left">
